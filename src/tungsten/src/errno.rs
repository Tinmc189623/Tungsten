// errno.rs — POSIX 错误码 (完整的 errno 常量)
// 对齐 Linux 6.x errno-base.h + errno.h
...
pub fn set_errno(err: i32) { unsafe { ERRNO = err; } }
pub fn get_errno() -> i32 { unsafe { ERRNO } }
pub fn errno_ptr() -> *mut i32 { unsafe { core::ptr::addr_of_mut!(ERRNO) } }
